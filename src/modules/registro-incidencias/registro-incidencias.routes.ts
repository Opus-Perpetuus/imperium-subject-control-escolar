...
import { registro_incidencias_flow } from "./registro-incidencias.flow.ts";
...
export const registro_incidencias_module = define_module({
  ...
  routes: [
    ...
    ...define_crud({
      ...
      fields: {
        ...
        tipo_incidencia_id: { type: "string", search: true },
  ...
  menu: [
    ...
    },
    {
      ...
      order: 9,
      pageId: "control-escolar.tipos-incidencia",
