...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-control-escolar"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-control-escolar"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-control-escolar \
    KIRLET_TECHNICAL_ID=subject-control-escolar \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
